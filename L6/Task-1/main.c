...
// Memory leak gives about 50% time increase as N = 10000000
// Only allocating single list gives about 33% time decrease
// Lists up to 1047501 entries can be allocated on the stack, about
// 4 MB of data
