...
// When n= 30 and m =3333333 a big drop in computation time is seen.
// Allocated bytes are around 15kB. Total L1 cache on vitsippa is 512kB, 
// divided by no of cores gives 16 kB per core which is strengthens the result.
